...
let retirementDate = new Date("2024-12-31T12:00:00");
retirementDate = retirementDate.toLocaleString("en-US", {timeZone: "Asia/Singapore"})
retirementDate = new Date(retirementDate)
retirementDate = retirementDate.getTime()
...
let timer = setInterval(function() {
  ...
  // get today's date
  let today = new Date().toLocaleString("en-US", {timeZone: "Asia/Singapore"});
//   console.log(today)
